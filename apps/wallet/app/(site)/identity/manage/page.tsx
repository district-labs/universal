                  ...
                  <div className="w-full max-w-screen-lg">
                    ...
                    <Card className="w-full p-5">
                      ...
                      <span className="mt-2 block font-bold text-neutral-500">
                        dis:uis:
                        <span className="text-neutral-700">{'84532'}</span>:
                        <span>
                          {universalDeployments[chainId as number].resolver}
                        </span>
                    ...
                    <Card className="mt-4 w-full p-5">
                      ...
                      <pre className="w-auto pb-4 font-mono text-xs">{`${JSON.stringify(query.data.parsed, null, 2)}`}</pre>
                    </Card>
                    <div className="mt-4 grid grid-cols-3 gap-x-5">
                      ...
                      <Card className="p-5">
                        ...
                        <p className="text-xs">
                          Your identity is anchored to Base Sepolia. An Ethereum
                          L2 managed by Coinbase.
                        </p>
                      </Card>
                      <Card className="p-5">
                    ...
                    <div className="mt-4 grid grid-cols-3 gap-x-5">
                      <Card className="content col-span-2 p-8">
                        ...
                        <p className="">
                          Universal Identity System (UIS) is a modern, scalable,
                          and flexible approach to decentralized identity. As
                          identity becomes increasingly important in our world,
