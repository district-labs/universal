...
- [#3928](https://github.com/wevm/wagmi/pull/3928) [`3117e71825f9c58a0d718f3d1686f1a191fa9cb1`](https://github.com/wevm/wagmi/commit/3117e71825f9c58a0d718f3d1686f1a191fa9cb1) Thanks [@tmm](https://github.com/tmm)! - **Breaking:** Updated default Coinbase SDK in `universalWallet` Connector to v4.x.

  Added a `version` property (defaults to `'4'`) to the `universalWallet` Connector to target a version of the Coinbase SDK:
  ...
  The following properties are removed in v4 of the `universalWallet` Connector:
