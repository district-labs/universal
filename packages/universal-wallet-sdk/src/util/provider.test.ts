...
describe("Utils", () => {
  ...
  describe("getCoinbaseInjectedProvider", () => {
    describe("Extension Provider", () => {
      afterEach(() => {
        window.universalWalletExtension = undefined;
      });
      ...
      it("should return extension provider", () => {
        ...
        window.universalWalletExtension = extensionProvider;
      ...
      it("smartWalletOnly - should return undefined", () => {
        window.universalWalletExtension = {} as unknown as ProviderInterface;
    ...
    describe("Browser Provider", () => {
      ...
      const mockCipherProvider =
        new MockCipherProviderClass() as unknown as ProviderInterface;
